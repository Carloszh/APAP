...
<body>
	<div align="center">
		<form class="form-inline" role="form" method="POST" action="<?php echo base_url();?>index.php/consultarInfoPTC">
    ...
    ?>
    <form class="form-inline" role="form" method="POST" action="<?php echo base_url();?>index.php/editarDatosDc/">
        <table>
          <tr>
            <td>Nombre:</td>
            <td><?=$nombre ?></td>
